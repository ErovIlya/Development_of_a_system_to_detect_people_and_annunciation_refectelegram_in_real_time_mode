...
keyboard_after_download_video = ReplyKeyboardMarkup(
    keyboard=[[hi_button, system_button, info_button], [task1_button, video_task1_button],
              [task2_button, video_task2_button], [set_points_button]],
    resize_keyboard=True)
keyboard_after_set_points = ReplyKeyboardMarkup(
    keyboard=[[next_button, cancel_button], [hi_button, system_button, info_button], [photo_button]],
    resize_keyboard=True)
keyboard_cancel = ReplyKeyboardMarkup(
    keyboard=[[cancel_button], [hi_button, system_button, info_button], [photo_button]],
    resize_keyboard=True
)
...
keyboard_task = ReplyKeyboardMarkup(
    keyboard=[[status_button, stop_button], [hi_button, system_button, info_button]],
    resize_keyboard=True
)
keyboard_video = ReplyKeyboardMarkup(
    keyboard=[[stop_button], [hi_button, system_button, info_button]]
)
...
def get_keyboard(_state) -> ReplyKeyboardMarkup:
    ...
    elif _state in [Form.point_state, Form.point_test]:
